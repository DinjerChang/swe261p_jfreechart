 ...
 */
public class CoverageTest implements ChartChangeListener {
...
//        assertEquals(chart1, chart2);
    ...
    /*
    Coverage Test on JFreeChart.java method:
    Before improvement:
        Coverage by line: 37% (173/463), by branch 31% (106/334)
    After improvement:
        Coverage by line: 63% (293/463), by branch 56%(188/334)
     */

    // The following section are  new Test added to improve coverage
    @Test
    // at line 321 in JFreeChat.java
    public void testTitleNullBranch(){
        JFreeChart jc = new JFreeChart(null,
                new Font("SansSerif", Font.PLAIN, 12), new PiePlot(), true);
        assertNull(jc.getTitle());
    }
    ...
    public void testFontNullBranch(){
        ...
        // new Font("SansSerif", Font.BOLD, 18) is default font
        assertEquals(jc.getTitle().getFont(),new Font("SansSerif", Font.BOLD, 18));
    }
    ...
    public void testGetAndSetElementHinting(){
        ...
        JFreeChart jc = new JFreeChart("Title",
                null, new PiePlot(), true);
        assertFalse(jc.getElementHinting());
        // set element Hinting to true
        jc.setElementHinting(true);
        assertTrue(jc.getElementHinting());
    }
    ...
    public void testSetBackgroundPaintBranch1(){
        ...
        JFreeChart jc = new JFreeChart( "test",new PiePlot<>());
        // first set background to null
        jc.setBackgroundPaint(null);
        assertNull(jc.getBackgroundPaint());
        // set background color to light gray
        jc.setBackgroundPaint(Color.LIGHT_GRAY);
        assertEquals(Color.lightGray,jc.getBackgroundPaint());
    ...
    public void testSetBackgroundPaintBranch2(){
        ...
        jc.setBackgroundPaint(jc.getBackgroundPaint());
//        System.out.println(jc.getBackgroundPaint());
        assertNull(this.lastChartChangeEvent);

        // set background to null
        jc.setBackgroundPaint(null);

        // set background color to null again to go in branch
        jc.setBackgroundPaint(null);
        assertNull(jc.getBackgroundPaint());
    ...
    @Test
    // at line 1271 to 1309 in JFreeChart.java
    public void testCreateImage(){
        JFreeChart jc = new JFreeChart( "test",new PiePlot<>());
        BufferedImage img = jc.createBufferedImage(500,600);
